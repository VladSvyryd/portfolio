    ...
    >
      <div className="homeColumn skills ">
        ...
        <div className="textContainer">
          <p>
            Front End developer with experience building responsive websites and
            web applications.
          </p>
          <p>
            I specialize in JavaScript (TypeScript) and have experience working
            with React.js and Angular. On the client side I am proficient in
            HTML, CSS, SASS and popular frameworks: bootstrap, semantic-ui,
            Angular Material, Onsen UI. My development is reinforced by basic
      ...
      >
        <motion.div
          ...
          animate="visible"
        >
          <motion.div variants={item} className={`${skill.js} ${skill.icon}`} />
          <motion.div
            variants={item}
          ...
          />
          <motion.div variants={item} className={`${skill.ts} ${skill.icon}`} />
        </motion.div>
      </div>
    </motion.div>
  );
